    ...
    <div className="w-full h-screen overflow-hidden flex flex-col items-center justify-center bg-art-white px-6 md:px-12 relative">
      <div className="w-full max-w-4xl space-y-8 z-10">
        ...
        <div className="text-center space-y-4">
          <h1 className="text-5xl md:text-8xl font-sans font-black tracking-tighter text-art-black uppercase leading-none">
            ARCHIVE.
          </h1>
          ...
          <AnimatePresence mode="wait">
            {errorMessage && (
              <motion.div
                ...
                exit={{ opacity: 0 }}
                className="absolute top-6 left-6 right-6 bg-red-100 text-red-800 text-xs font-mono p-3 border-2 border-red-800 text-center uppercase tracking-widest font-black"
              >
                {errorMessage}
              </motion.div>
            )}
            ...
            >
              ...
              <div className="flex gap-4">
                <button
                  ...
                  className="px-8 py-4 border-2 border-art-black rounded-xl font-black uppercase tracking-widest text-xs hover:bg-art-black/5"
                >
                  Cancel
                </button>
                <button
